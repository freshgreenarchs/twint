...
def User(ur):
    ...
    if 'url' in ur['data']['user']['legacy']:
        _usr.url = ur['data']['user']['legacy']['url']    # parsing date to user-friendly format
    ...
    if 'profile_banner_url' in ur['data']['user']['legacy']:
        _usr.background_image = ur['data']['user']['legacy']['profile_banner_url']    # TODO : future implementation
